...
class TestPredevAPIInit:
    ...
    def test_init_with_enterprise_auth(self):
        ...
        assert "x-enterprise-api-key" in client.headers
        assert client.headers["x-enterprise-api-key"] == "enterprise_key"
    
    def test_init_with_custom_base_url(self):
        """Test initialization with custom base URL"""
        client = PredevAPI(api_key="test_key", base_url="https://custom.api.com/")
...
class TestFastSpec:
    ...
    def test_fast_spec_success(self, mock_post):
        ...
        mock_response.json.return_value = {"spec_id": "123", "url": "https://example.com/spec"}
...
class TestDeepSpec:
    ...
    def test_deep_spec_success(self, mock_post):
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {"spec_id": "456", "url": "https://example.com/deep-spec"}
        mock_post.return_value = mock_response
...
class TestGetSpecStatus:
    ...
    def test_get_spec_status_success(self, mock_get):
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {"status": "completed", "spec_id": "123"}
